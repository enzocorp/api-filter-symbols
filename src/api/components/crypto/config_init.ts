...
//MARKETS
export const market_volume_usd1day: number = 700000 //Volume d"echange journalier minumum
export const market_symbolsCount : number = 3//Nombres minimum de symboles que dois contenir le market

//SYMBOLS
export const symbol_volume_usd1day : number = 90000//Volume d'echange minimum journalier pour la selection du symbole
